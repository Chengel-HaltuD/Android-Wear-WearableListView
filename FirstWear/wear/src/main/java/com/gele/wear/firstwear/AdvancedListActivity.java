...
public class AdvancedListActivity extends Activity implements WearableListView.ClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new MyListAdapter(AdvancedListActivity.this);
    ...
    static {
        ...
        listItems.add(R.mipmap.ic_action_attach);
        listItems.add(R.mipmap.ic_action_call);
        listItems.add(R.mipmap.ic_action_copy);
        listItems.add(R.mipmap.ic_action_cut);
        listItems.add(R.mipmap.ic_action_delete);
        listItems.add(R.mipmap.ic_action_done);
        listItems.add(R.mipmap.ic_action_edit);
        listItems.add(R.mipmap.ic_action_locate);
        listItems.add(R.mipmap.ic_action_mail);
        listItems.add(R.mipmap.ic_action_mail_add);
        listItems.add(R.mipmap.ic_action_microphone);
        listItems.add(R.mipmap.ic_action_photo);
    }
    ...
    public class MyListAdapter extends WearableListView.Adapter {
        ...
        public WearableListView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            return new WearableListView.ViewHolder(mInflater.inflate(R.layout.row_advanced_item_layout, null));
        }
...
//            imgView.setImageResource(resourceId);
            ...
            TextView txtView = (TextView) viewHolder.itemView.findViewById(R.id.text);
            txtView.setText(String.format("Item %d", i));

            Integer resourceId = listItems.get(i);
            CircledImageView imgView = (CircledImageView) viewHolder.itemView.findViewById(R.id.image);
            imgView.setImageResource(resourceId);
        }
    ...
    /*public final class MyItemView extends FrameLayout implements WearableListView.Item {
